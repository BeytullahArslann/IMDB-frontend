...
export default {
  ...
  methods: {
    ...
    updatePassword() {
      if (this.passwordValueOld != this.userData.password) {
        this.$toast({
        ...
        if (this.newPasswordValue != this.RetypePassword) {
          ...
          this.userData.password = this.newPasswordValue
          HTTP.put("api/User/" + this.userData.id, this.userData)
            .then((result) => {
              localStorage.setItem("userInfo", JSON.stringify(result.data));
              this.$toast({
            component: ToastificationContent,
            props: {
              title: 'The password has been successfully updated.',
              icon: 'ThumbsUpIcon',
              variant: 'success',
            },
          })
            ...
            component: ToastificationContent,
            props: {
              title: 'The operation could not be performed, please try again later.',
              icon: 'AlertCircleIcon',
              variant: 'danger',
            },
          })
