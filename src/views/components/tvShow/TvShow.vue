...
<template>
  <div class="row">
    <tv-show-header class="col-12" :headerData="movie" />
    <div class="col-12">
      <swiper
    ...
    <div class="col-12 d-flex justify-content-center mb-2">
      <b-button
        ...
        variant="primary"
        style="color: red"
        >Show Similiar Tv Shows</b-button
      >
      <b-button
        v-if="showSimiliarMovies"
        @click="showSimiliarMovies = !showSimiliarMovies"
        variant="danger"
        style="color: red"
        >Hide Similiar Tv Shows</b-button
      >
    </div>
...
import TvShowHeader from "@/views/components/tvShow/TvShowHeader.vue";
...
import ReviewsComponent from "../movie/Reviews.vue";
...
export default {
  ...
  created() {
    axios
      .get(
        "https://api.themoviedb.org/3/tv/" + this.movieId + "/credits?api_key=dbf838417cf64de0dbe2a81c2318610e&language=en-US"
      )
      .then((result) => {
    ...
    axios
      .get(
        "https://api.themoviedb.org/3/tv/" + this.movieId + "/reviews?api_key=dbf838417cf64de0dbe2a81c2318610e&language=en-US&page=1"
      )
      .then((result) => {
    ...
    axios
      .get(
        "https://api.themoviedb.org/3/tv/" + this.movieId + "/similar?api_key=dbf838417cf64de0dbe2a81c2318610e&language=en-US&page=1"
      )
      .then((result) => {
        axios
          .get(
          ...
          .then((genres) => {
            ...
            this.similiarMovies = result.data.results
          });
      })
    axios.get("https://api.themoviedb.org/3/tv/" + this.movieId + "?api_key=dbf838417cf64de0dbe2a81c2318610e&language=en-US")
      .then((result) => {
